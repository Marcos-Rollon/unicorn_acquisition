...
class WebsocketServerManager:
    ...
    def __init__(self, 
        ...
        self._server: Optional[eventlet.wsgi.server] = None
    ...
    def init(self, host : str = "", port : int = 8000, cors_allowed_origins : str = "*"):
        ...
        if self._sio != None or self._app != None or self._server != None:
            ...
            return
        self._sio = socketio.Server(cors_allowed_origins = cors_allowed_origins)
        ...
        #Starts the server
        self._server = eventlet.wsgi.server(eventlet.listen((host, port)), self._app, log=open(os.devnull,"w"))
